...
public abstract class Auto {
    ...
    private boolean gameAA(int var1, int var2, int var3) {
        ...
        for (int var4 = 0; var4 < Auto.gameAN.size(); ++var4) {
            Mob var5 = (Mob)Auto.gameAN.elementAt(var4);
            if (var5.levelBoss == 0 || var5.hp <= 0 || var5.status == 0) continue;
            boolean var6;
            if (var5.levelBoss != 3) {
            ...
            if (skill1 != null) {
                ...
                if (var26.gameAA() && (Char.DungHoTro || this instanceof As20)) {
                    block11: for (int var25 = 0; var25 < var3.vSkillFight.size(); ++var25) {
                        ...
                        if (var19 == null || System.currentTimeMillis() - var19.lastTimeUseThisSkill < (Code.skillDelay >= 0 ? (long)Code.skillDelay : (long)var19.coolDown - 300L)) continue;
                ...
                if (var26.template.type == 2) {
                    if (System.currentTimeMillis() - var26.lastTimeUseThisSkill >= var26.getCoolDown()) {
