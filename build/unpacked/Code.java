...
implements Runnable {
    ...
    public static int skillDelay = 200;
                    ...
                    if (gameAB != null) {
                        ...
                        if (TileMap.gameAD(TileMap.mapID) || TileMap.gameAF(TileMap.mapID)) {
                            ...
                            if ((Char.AutoMuaFood || gameAB instanceof As10) && var4 > 1 && var3.ctaskId > 3) {
                                int n = gameAB instanceof As10 ? (var3.ctaskId >= 9 ? 10 : 1) : (var19 = Char.CapFood);
    ...
    public static boolean gameAF(String var0) {
        ...
        if (var31.equals("speed")) {
            if (var1 <= 0) var1 = 10;
            Char.speedGame = var1;
            GameScr.gameAC("Hack speed game: " + var1 + "ms");
            return true;
        }
        if (var31.equals("td")) {
            if (var1 < 0) var1 = 50;
            Code.skillDelay = var1;
            GameScr.gameAC("Hack t\u1ed1c \u0111\u00e1nh / delay: " + var1 + "ms");
            return true;
        }
        if (var31.equals("hp")) {
            if (var1 <= 0) var1 = 50;
            Char.aHpValue = var1;
            Char.DungHp = true;
            GameScr.gameAC("Auto HP khi HP < " + var1 + "%");
            return true;
        }
        if (var31.equals("mp")) {
            if (var1 <= 0) var1 = 50;
            Char.aMpValue = var1;
            Char.DungMp = true;
            GameScr.gameAC("Auto MP khi MP < " + var1 + "%");
            return true;
        }
        if (var31.equals("food")) {
            Char.DungFood = !Char.DungFood;
            if (Char.DungFood) {
                GameScr.gameAC("B\u1eadt auto d\u00f9ng th\u1ee9c \u0103n");
            } else {
                GameScr.gameAC("T\u1eaft auto d\u00f9ng th\u1ee9c \u0103n");
            }
            return true;
        }
        if (var31.equals("abuff")) {
            Char.DungHoTro = !Char.DungHoTro;
            if (Char.DungHoTro) {
                GameScr.gameAC("B\u1eadt auto buff h\u1ed7 tr\u1ee1");
            } else {
                GameScr.gameAC("T\u1eaft auto buff h\u1ed7 tr\u1ee1");
            }
            return true;
        }
        ...
        if (var31.equals("nhanda")) {
            ...
            if (AutoNhanDa.isAuto) {
                GameScr.gameAC("B\u1eadt auto nh\u1eadn \u0111\u00e1 62");
                new Thread(new AutoNhanDa()).start();
            } else {
                GameScr.gameAC("T\u1eaft auto nh\u1eadn \u0111\u00e1 62");
            }
            return true;
        }
